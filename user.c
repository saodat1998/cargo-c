...
int main (int argc, char *argv[])
{
    ...
    MainWindow  = GTK_WIDGET(gtk_builder_get_object(builder, "window_order"));
    MainWindow2  = GTK_WIDGET(gtk_builder_get_object(builder, "MainWindow"));
    //window_drinks  = GTK_WIDGET(gtk_builder_get_object(builder, "window_order"));
    ...
    gtk_widget_hide (GTK_WIDGET(MainWindow2));
